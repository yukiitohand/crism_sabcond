function [Yif_cor,Bg_est,AB_est,T_est] = sabcondv4(obs_id,varargin)
% huwacb option
nIter = 5;
vis = 0;
lambda_a = 0.01;
...
t_mode = 2;
% file name option
mt = 'sabcondv4'; % method type
additional_suffix = 'l1_gadmm_a_v2_ca_ice';
isdebug = false;
save_pdir = './resu/';
...
%         [Ahitranlib,infoAhitranlib] = crmsab_loadlibc_hitranlib(opthitranlib,basenameWA,c,bands_opt,WA(:,c),'CNTRMVL',0,'overwrite',1);
...
%         [ logt_est,logYifc_cor,logAB,logBg,logYifc_cor_ori,logYifc_isnan,ancillary,rr_ori_c,vldpxl_c]...
%             = sabcondc_v4l1_a(Alib,Aicelib,logYif(:,:,c),WA(:,c),logtc,'GP',GP(:,:,c),...
%               'LAMBDA_A',lambda_a,'Lambda_a_ice',0.0,'NITER',nIter,'VIS',vis,'maxiter',200);
        [ logt_est,logYifc_cor,logAB,logBg,logIce,logYifc_cor_ori,logYifc_isnan,ancillary,rr_ori_c,vldpxl_c]...
            = sabcondc_v4l1_b(Alib,Aicelib,logYif(:,:,c),WA(:,c),logtc,'GP',GP(:,:,c),...
