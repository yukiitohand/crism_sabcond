function [Yif_cor,Bg_est,AB_est,T_est] = sabcondv3_17D33test(obs_id,varargin)
% huwacb option
nIter = 5;
vis = 0;
lambda_a = 0.01;
...
additional_suffix = 'l1_gadmm_a_v2_17D33test';
isdebug = false;
save_pdir = './resu/';
...
%         Alib2 = Alib;
%         Alib2(:,k_i) = Alib(:,k_i)*5;
%         Alib2(:,pyrox_i) = Alib(:,pyrox_i)*2;
...
%               'LOGYIFC_CAT',logYifc_cat(:,:,c));%,'LOGYRAIFC_CAT',logYraifc_cat(:,:,c));
        [logt_est,logYifc_cor100,logAB100,logBg100,logYifc_cor_ori100,logYifc_isnan100,ancillary100,rr_ori_c100,vldpxl_c100]...
            = sabcondc_v3l1_e(Alib2,logYif(:,1:100,c),WA(:,c),logtc,'GP',GP(:,:,c),...
        ...
        [ logYifc_cor,logAB,logBg,logYifc_cor_ori,logYifc_isnan,ancillary,rr_ori_c,vldpxl_c]...
            = sabcondc_v3l1_givent(Alib2,logYif(:,:,c),WA(:,c),logt_est,'GP',GP(:,:,c),...
