...
[Ah2o_hitran,infoh2o_hitran] = crism_load_lib('absxsecH2Olib_HITRAN',3,wabasename,...
                                  c,'METHOD','interpCRISMspc','retainRatio',0.1);
[Aco2_hitran,infoco2_hitran] = crism_load_lib('absxsecCO2lib_HITRAN',3,wabasename,...
                                  c,'METHOD','interpCRISMspc','retainRatio',0.1);
switch opt
    case 1
