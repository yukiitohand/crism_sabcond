...
switch libname
    ...
    case 'Hapke_H2Oicelib_Grundy1998'
        [infoHapke_H2Oicelib_Grundy1998] = load_Hapke_H2Oice_Grundy1998(opt);
        xmult = 1;
        infoAname = 'infoHapke_H2Oicelib_Grundy1998';
    otherwise
        error([ ...
            ...
            elseif ~exist(cachefilepath,'file') || overwrite
                ...
                if flg
                    switch libname
                        ...
                        case 'Hapke_H2Oicelib_Grundy1998'
                            [AHapke_H2Oicelib_Grundy1998,option]...
                                = libstruct_convoluter(infoHapke_H2Oicelib_Grundy1998,wvc,...
                                methodbl,'YFieldName','r','SB',sbc,'retainRatio',retainRatio,'XMULT',xmult,'Batch',1);
                            save(cachefilepath,'AHapke_H2Oicelib_Grundy1998','option');
                        otherwise
