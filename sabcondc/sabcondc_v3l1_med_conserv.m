function [ logt_est,logYifc_cor,logAB,logBg,logYifc_cor_ori,logYifc_isnan,ancillary,rr_ori,vldpxl] = sabcondc_v3l1_med_conserv( Alib,logYifc,wvc,logtc,varargin )
...
logtc_1d = nanmean(logtc*Xlogtc./sum(Xlogtc,1),2);
