...
if is_debug
    ...
    for li=liList
        plot(ax_spc,WA,logYif(:,li),'.-','Color',[0.5 0.5 0.5],...
            'DisplayName','yif');
        hold(ax_spc,'on');
        plot(ax_spc,WA,logYif_cor_test(:,li),'.-','Color',cols(1,:),...
            'DisplayName','cor iter=0 before t upd');
        hold(ax_spc,'on');
        plot(ax_spc,WA,logYif_cor_1nan(:,li),'.-','Color',cols(2,:),...
            'DisplayName','cor good iter=0  before t upd');
        plot(ax_spc,WA,logYif_cor_bad_1nan(:,li),'o','Color',cols(2,:),...
            'DisplayName','cor bad iter=0  before t upd');
        plot(ax_spc,WA,ymodel(:,li),'-','Color',cols(2,:),...
         'DisplayName','cor model iter=0 before t upd');
        plot(ax_spc,WA,bg(:,li),'-','Color',cols(2,:),...
...
if is_debug
    ...
    for li=liList
        ...
        plot(ax_spc,WA,logYif_cor_1nan(:,li),'.-','Color',cols(2,:),...
            'DisplayName','cor good iter=0  before t upd');
        plot(ax_spc,WA,logYif_cor_bad_1nan(:,li),'x','Color',cols(2,:),...
            'DisplayName','cor bad iter=0  before t upd');
...
if is_debug
    ...
    for li=liList
        plot(ax_spc,WA,logYif_cor_test(:,li),'.-','Color',cols(3,:),...
            'DisplayName','cor iter=0 after t upd');
        hold(ax_spc,'on');
        plot(ax_spc,WA,logYif_cor_1nan(:,li),'.-','Color',cols(4,:),...
            'DisplayName','cor good iter=0  after t upd');
        plot(ax_spc,WA,logYif_cor_bad_1nan(:,li),'x','Color',cols(4,:),...
