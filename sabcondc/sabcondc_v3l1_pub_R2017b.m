function [ logt_est,logYifc_cor,logAB,logBg,logIce,logYifc_cor_ori,logYifc_isnan,...
    Xt,Xlib,Xice,vldpxl]...
    = sabcondc_v3l1_pub_R2017b( Alib,logYifc,wvc,logtc,gp,varargin )
...
%
% This is the version compatible to R2017b or earlier. (relating to new input 
% patterns of functions "sum" and "mean".)
% diverged from sabcondc_v3l1_pub.m of the version 776c8c1
%
% INPUT PARAMETERS
%   Alib: array, [B x Nlib]
%        library matrix
