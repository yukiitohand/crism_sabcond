...
function [ logt_est,logYifc_cor,logAB,logBg,logYifc_cor_ori,logYifc_isnan,ancillary,rr_ori,vldpxl] = sabcondc_v4l1_1( Alib,Aice,logYifc,wvc,logtc,varargin )
...
res_bprmvd = R_bprmvd - A_bprmvd(:,idxAlogtc) * Xlogtc - logIce_bprmvd;
...
%     logt_est = update_logt_est(R,X(1,:));
    ...
    if ~isempty(Aice)
        res_bprmvd = R_bprmvd-A_bprmvd(:,1)*X(1,:)-logIce_bprmvd;
